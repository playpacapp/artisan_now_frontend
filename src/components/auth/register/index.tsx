...
import { DefaultButton, IconInput, LinkButton, Wrapper } from "../../ui/index";
      ...
      <Wrapper className="h-[100vh] flex items-center justify-center">
        <div className="relative w-full md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[30%] flex flex-col items-center justify-center px-10 py-10 gap-y-5">
          ...
          <div className="w-full flex flex-col gap-y-5">
            ...
            <IconInput type="password" placeholder="Confirm Password" path="" />
          </div>
          <div className="w-fit">
            <DefaultButton className="w-[150px]" label="Register" />
          </div>
